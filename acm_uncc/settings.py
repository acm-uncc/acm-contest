"""
Django settings for acm_uncc project.
...
WSGI_APPLICATION = 'acm_uncc.wsgi.application'
...
LOGIN_REDIRECT_URL = 'contest:index'
LOGOUT_REDIRECT_URL = 'contest:index'
